...
export type JobStatus = "Open" | "InProgress" | "PendingRelease" | "Completed" | "Disputed" | "Cancelled";
 ...
 */
export declare function encodeDescription(task: string, capability?: string): string;
/**
 * Decode a capability tag from a raw on-chain description.
 */
export declare function decodeDescription(raw: string): {
    capability?: string;
    task: string;
};
